...
function obtenerMayor(x, y) {
  ...
  var num1 = x;
  var num2 = y;
  if (num1 === num2) return num1; else if (num1 > num2) return num1; else return num2;
}
...
function mayoriaDeEdad(edad) {
  ...
  var years = edad;
  if (years >= 18) return "Allowed"; else return "Not allowed";
}
...
function conection(status) {
  ...
  else if (estado !== 1) return "Offline";
  else if (estado !== 2) return "Offline";
...
function fizzBuzz(numero) {
  ...
  var num1 = numero % 3;
  var num2 = numero % 5;
  if (num1 === 0 && num2 === 0) {return "fizzbuzz";}
  if (num1 === 0) {return "fizz";} 
  if (num2 === 0) {return "buzz";}
